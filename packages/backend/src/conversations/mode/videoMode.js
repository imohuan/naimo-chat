 ...
 */
const videoModePrompt = require("../prompts/videoMode");
...
async function processVideoMode(context) {
  ...
  // 加载系统提示词并替换变量
  const systemPrompts = replaceVariablesInMessages(videoModePrompt, {});
...
module.exports = processVideoMode;
